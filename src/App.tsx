    ...
    <div className="h-full bg-slate-50 flex flex-col font-sans text-slate-900 overflow-hidden">
      <header className="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between shadow-sm flex-shrink-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold tracking-tight text-slate-800 uppercase">Quản Lý Danh Sách</h1>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-slate-100 border-2 border-white shadow-inner flex items-center justify-center text-slate-400 hover:text-red-500 transition-colors"
